...
<template>
  <div class="border-b border-gray-300 pb-4">
    <div class="relative grid grid-cols-1 gap-x-4 md:grid-cols-2">
      <button
        type="button"
        class="absolute -top-1 -left-1.5 flex items-center justify-center p-1.5 text-gray-400 hover:text-gray-500"
      >
        <span class="sr-only">Previous month</span>
        <ArrowLeftIcon class="h-5 w-5 text-dark-text" aria-hidden="true" />
      </button>
      <button
        type="button"
      ...
      >
        ...
        <ArrowRightIcon class="h-5 w-5 text-dark-text" aria-hidden="true" />
      </button>
      <section
        ...
        >
          <button
            ...
            :class="[
              ...
              'relative hover:bg-gray-100 focus:z-10',
            ]"
          >
            <time
              :datetime="day.date"
              :class="[
                ...
                'mx-auto flex items-center justify-center rounded-l-full py-1.5',
              ]"
