<template>
    <div class="bg-white w-full px-4 z-10">
        <div class="min-w-0 w-full flex-1 ">
            <div class="flex w-full items-center justify-center  py-2 md:mx-auto lg:mx-0 xl:px-0 space-x-2">
                <div class="w-full">
                ...
                <div class=" w-24 z-30 whitespace-nowrap">
                    <WhiteButton buttonText="Save as"/>
                </div>
                
                <div>
                    <button type="button" class="inline-flex items-center px-2 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded text-gray-700 bg-white hover:bg-gray-50">
                        •••
                    </button>
                </div>
            </div>
