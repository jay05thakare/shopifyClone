  ...
  <div class="flex flex-col">
    <div class="-my-2 sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow  border-b border-gray-200 sm:rounded-lg divide-y divide-gray-200 overflow-hidden">
          <h2 class=" font-semibold text-base text-dark-text min-w-full bg-white py-3 px-4">Recent marketing</h2>
